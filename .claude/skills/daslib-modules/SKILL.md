...
instead of reading daslib sources by hand; the pinned toolchain (0.6.4 @ 1524b3bf) is the
version that matters, not whatever newer daScript checkout is on the machine.
