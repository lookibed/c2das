...
| Canonical c2das runtime cases | green | `python3 scripts/run_c2das_cases.py --all-ready` proves fresh C reference and WSL daScript equivalence for p17–p28, p30–p41. |
