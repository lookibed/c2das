...
```powershell
D:\Backups\WASI\wasi-sdk-24.0\bin\clang.exe --% --target=wasm32 -O2 -nostdlib -Wl,--no-entry -Wl,--export-all -Itests/manual/h264bsd-mp4/include tests/manual/h264bsd-mp4/src/module.c tests/manual/h264bsd-mp4/src/shim.c tests/manual/h264bsd-mp4/src/minimp4.c tests/manual/h264bsd-mp4/src/h264bsd.c -o tests/manual/h264bsd-mp4/generated/h264mp4.wasm
```

```powershell
D:\Backups\wasmtime\wasmtime-v24.0.1\wasmtime.exe -C cache=n --invoke h264mp4_decode_hash tests/manual/h264bsd-mp4/generated/h264mp4.wasm 8
D:\Backups\wasmtime\wasmtime-v24.0.1\wasmtime.exe -C cache=n --invoke h264mp4_probe_width tests/manual/h264bsd-mp4/generated/h264mp4.wasm
D:\Backups\wasmtime\wasmtime-v24.0.1\wasmtime.exe -C cache=n --invoke h264mp4_probe_height tests/manual/h264bsd-mp4/generated/h264mp4.wasm
D:\Backups\wasmtime\wasmtime-v24.0.1\wasmtime.exe -C cache=n --invoke h264mp4_probe_frame_count tests/manual/h264bsd-mp4/generated/h264mp4.wasm 8
D:\Backups\wasmtime\wasmtime-v24.0.1\wasmtime.exe -C cache=n --invoke h264mp4_probe_first_frame_hash tests/manual/h264bsd-mp4/generated/h264mp4.wasm
D:\Backups\wasmtime\wasmtime-v24.0.1\wasmtime.exe -C cache=n --invoke h264mp4_probe_last_frame_hash tests/manual/h264bsd-mp4/generated/h264mp4.wasm 8
```

```powershell
$text = & target\release\spider-cli.exe tests\manual\h264bsd-mp4\generated\h264mp4.wasm -t lua-no-ffi
$utf8NoBom = New-Object System.Text.UTF8Encoding($false)
[System.IO.File]::WriteAllText((Resolve-Path "tests/manual/h264bsd-mp4/generated/h264mp4.lua"), ($text -join [Environment]::NewLine), $utf8NoBom)
```

```powershell
luajit tests/manual/h264bsd-mp4/main.lua lua-no-ffi 8
```
...
- [host_main.lua](/D:/Backups/Spider/tests/manual/h264bsd-mp4/host_main.lua:1)

Run it like this:

```powershell
luajit tests/manual/h264bsd-mp4/host_main.lua lua-no-ffi
```

Or with your own baseline `.mp4`:

```powershell
luajit tests/manual/h264bsd-mp4/host_main.lua lua-no-ffi path\to\your.mp4
```

Decode one exact frame without fallback:

```powershell
luajit tests/manual/h264bsd-mp4/host_main.lua lua-no-ffi tests/manual/h264bsd-mp4/fixtures/sample.mp4 --frame 7
```

Decode every available frame, optionally capped by a max count:

```powershell
luajit tests/manual/h264bsd-mp4/host_main.lua lua-no-ffi tests/manual/h264bsd-mp4/fixtures/sample.mp4 --all-frames
luajit tests/manual/h264bsd-mp4/host_main.lua lua-no-ffi tests/manual/h264bsd-mp4/fixtures/sample.mp4 --all-frames 8
```

Expected outputs:
- `tests/manual/h264bsd-mp4/generated/frames/sample_frame000.ppm`
- `tests/manual/h264bsd-mp4/generated/frames/sample_frame007.ppm` (or `frame006..frame001` fallback)
...
target\release\wasmtime-host-runner.exe --fixture h264mp4 --mode baseline --wasm tests\manual\h264bsd-mp4\generated\h264mp4.wasm --input tests\manual\h264bsd-mp4\fixtures\sample.mp4 --frames 12 --output-dir tests\manual\h264bsd-mp4\generated\frames_wasmtime
```
...
```powershell
ffmpeg -y -i D:\Backups\Spider\tests\manual\h264bsd-mp4\generated\frames\sample_frame000.ppm D:\Backups\Spider\tests\manual\h264bsd-mp4\generated\frames\sample_frame000.png
ffmpeg -y -i D:\Backups\Spider\tests\manual\h264bsd-mp4\generated\frames\sample_frame007.ppm D:\Backups\Spider\tests\manual\h264bsd-mp4\generated\frames\sample_frame007.png
```

Generate another small baseline-profile sample:

```powershell
ffmpeg -y -f lavfi -i testsrc2=size=96x64:rate=12 -frames:v 12 -c:v libx264 -profile:v baseline -pix_fmt yuv420p -bf 0 -an D:\Backups\Spider\tests\manual\h264bsd-mp4\fixtures\my_sample.mp4
```

Run the host smoke directly on your own `.mp4`:

```powershell
luajit D:\Backups\Spider\tests\manual\h264bsd-mp4\host_main.lua lua-no-ffi D:\path\to\your_video.mp4
```
...
```powershell
luajit D:\Backups\Spider\tests\manual\h264bsd-mp4\host_main.lua lua-no-ffi D:\Backups\Spider\tests\manual\h264bsd-mp4\fixtures\your_video_baseline.mp4
```
