...
```sh
bash tests/manual/plmpeg-stream/check_c_graph.sh
bash tests/manual/plmpeg-stream/transpile_canonical_graph.sh
bash tests/manual/plmpeg-stream/run_end_to_end.sh
```
